...
# from AppsSDS.DataPeserta import DataPesertaSeleksi,DataPesertaTes
...
# 		print (self.HasilListJob2.keys())
		...
		for Joblist in self.HasilListJob2.keys():
			self.m_panelPage6.m_listCtrlCR2.InsertItem(self.index2,Joblist)
			self.index2+=1
