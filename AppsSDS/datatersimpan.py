...
class FrameSimpanSukses(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.m_staticText1 = wx.StaticText(self.m_panel1, wx.ID_ANY, u"Data Berhasil Disimpan", wx.DefaultPosition, wx.DefaultSize, 0)
...
if __name__ == '__main__':
    root = wx.App()
    openFrame = FrameSimpanSukses(None)
    openFrame.Show(True)
    root.MainLoop()
    pass
