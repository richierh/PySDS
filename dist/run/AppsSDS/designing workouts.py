...
class Login_Register:
    def __init__(self,master):
        ...
        self.breakfast_Intake = StringVar()
        self.lunch_Intake = StringVar()
        self.dinner_Intake = StringVar()
        self.snacks_Intake = StringVar()
...
##        self.breakfast_Intake.insert('')
##        self.lunch_Intake.insert('')
##        self.dinner_Intake.insert('')
##        self.snacks_Intake.insert('')
        print (isinstance(self.breakfast_Intake.get(),str))
        try :
            totalintake = int(self.breakfast_Intake.get())+ int(self.lunch_Intake.get())\
                + int(self.dinner_Intake.get()) + int(self.snacks_Intake.get())
            ...
            try:
                isinstance(int(self.breakfast_Intake.get()),int)
            except:
                ms.showerror('Error!','breakfast')

            try :
                isinstance(int(self.lunch_Intake.get()),int) 
            except :
                ms.showerror('Error!','lunch')

            try :
                isinstance(int(self.dinner_Intake.get()),int) 
                
            except :
                ms.showerror('Error!','dinner')

            try :
                isinstance(int(self.snacks_Intake.get()),int)  
            except :
            
                ms.showerror('Error!','snacks')
            pass
    def log(self):
        self.username.set('')
        self.password.set('')
